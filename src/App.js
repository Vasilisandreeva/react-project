...
function App() {
  ...
  return (
    <div className={'simpsons'}>
        <Simpson item={simpsons[0]}/>
        <Simpson item={simpsons[1]}/>
        <Simpson item={simpsons[2]}/>
        <Simpson item={simpsons[3]}/>
        <Simpson item={simpsons[4]}/>
